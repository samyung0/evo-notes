...
) => createRoute({ getParentRoute: () => rootRoute, path, component: lazyRouteComponent(importer) });

const routes = [
  createRoute({ getParentRoute: () => rootRoute, path: '/', component: lazyRouteComponent(() => import('@/routes/Dashboard')) }),

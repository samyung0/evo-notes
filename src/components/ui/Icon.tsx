...
const PATHS = {
  ...
  microphone: ['M12 3a3 3 0 00-3 3v6a3 3 0 006 0V6a3 3 0 00-3-3z', 'M5 11a7 7 0 0014 0', 'M12 18v3', 'M8.5 21h7'],
  book: [
    'M4 5.5A2.5 2.5 0 016.5 3H19v15H6.5A2.5 2.5 0 004 20.5z',
    'M4 20.5A2.5 2.5 0 016.5 18H19v3',
  ],
  flashcards: [
  ...
  quiz: [
    'M9.2 9a2.8 2.8 0 115.2 1.4c-.6 1-1.9 1.3-2.4 2.4',
    'M12 17h.01',
    'M12 3.5a8.5 8.5 0 100 17 8.5 8.5 0 000-17z',
  ],

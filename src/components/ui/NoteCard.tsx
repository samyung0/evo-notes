...
const THEME: Record<NoteTheme, { bg: string; fg: string; muted: string }> = {
  green: { bg: 'var(--note-green-bg)', fg: 'var(--note-green-fg)', muted: 'var(--note-green-fg-muted)' },
  purple: { bg: 'var(--note-purple-bg)', fg: 'var(--note-purple-fg)', muted: 'var(--note-purple-fg-muted)' },
  greenSoft: { bg: 'var(--note-green-soft-bg)', fg: 'var(--note-green-soft-fg)', muted: 'var(--note-green-soft-fg)' },
  purpleSoft: { bg: 'var(--note-purple-soft-bg)', fg: 'var(--note-purple-soft-fg)', muted: 'var(--note-purple-soft-fg)' },
};
...
export function NoteCard({ title, body, date, theme = 'green', onMenu, className, style, ...rest }: NoteCardProps) {
  const t = THEME[theme];
  return (
    <div
